(function($) {
  ...
  $(function() {
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div style="width:20px; height:20px; border-radius: 50%; margin-left:90px"></div><p class="mb-0"><b>8</b>countries</p></div>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
        },
    ...
    if ($("#expat-chart").length) {
      ...
      var northAmericaChartCanvas = $("#expat-chart").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('expat-legend').innerHTML = northAmericaChart.generateLegend();
